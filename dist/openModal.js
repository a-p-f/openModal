(function () {
	...
	window.openModal = function (url, onload, onclose) {
	  ...
	  */
	  ...
	  addEventListener('click', cancel, true); // force focus to stay in iframe
	  ...
	  iframe.style = 'position: fixed; top: 0; left: 0; width: 100%; height: 100%; border: none; margin: 0; padding: 0;'; // TODO - fallback for browsers not supporting position: fixed (Opera Mini)
